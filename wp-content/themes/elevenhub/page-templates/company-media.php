...
if ( is_user_logged_in() ) {
	...
	// Load the media view if the $company_id is actuall company.
	if ( isset( $company_id ) && get_user_meta( $company_id, "account_association", true ) == "company" ) { require_once get_template_directory() ."/views/company-view-media.php"; }
} else {
	/* Load public view */
